...
course:
    ...
    edstem: https://edstem.org/us/courses/83980
    website: https://ds100.org/fa25/
    logistics_ta: TBD
    repo: https://github.com/DS-100/fa25
    comms_ta: data100.support@berkeley.edu
    head_ta: TBD
    email: data100.instructors@berkeley.edu
    final_exam_slot: Wednesday, December 17, 8-11am
...
# Frequently Asked Questions for Fall 2025 Data 100
{: .no_toc }
...
<!-- The Fall 2025 course website is not yet live. The Spring 2025 website can be found [here](https://ds100.org/sp25/). -->
...
The instructors are not able to provide permission codes or any new information about enrollment in Data 100 at this time. Please refer to the [Data Science Fall 2025 Courses page]({{page.course.classes_page}}){:target="_blank"} and  the [Data 001 Ed]({{page.course.data001edstem}}){:target="_blank"}, which includes all information currently available about enrolling in Fall 2025 classes. If you are not able to find an answer to your question there, please email [ds-advising@berkeley.edu](mailto:ds-advising@berkeley.edu).
...
There is **one** three-hour written final on Wednesday, 12/17, 8-11am.
...
- You will have the option to sign up for a one hour slot to take the first midterm Wednesday 10/15, Thursday 10/16, or Friday 10/17. 

- You will have the option to sign up for a one hour slot to take the second midterm Wednesday 11/19, Thursday 11/20, or Friday 11/21. 
...
Discussion sections and sign-ups will be released within the first two days of class. Discussions will occur at various times on Tuesdays and Wednesdays. There will be no lab sessions. See our course policies for more information about labs.
...
Please e-mail [{{page.course.email}}](mailto:{{page.course.email}}) and we will get back to you. Note that to ensure more timely responses, this address is monitored by Josh, Jake (Head TA), and multiple lead GSIs. You should only contact Josh directly for matters that require strict privacy and his direct attention.

---
We’re excited to have you in the class!

Josh (Professor), Jake (Head TA), and the Fall 2025 instructional team.