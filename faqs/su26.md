...
course:
    data001edstem: https://edstem.org/us/courses/22867/discussion
    edstem: TBD
    website: https://ds100.org/su26/
    logistics_ta: TBD
    repo: https://github.com/DS-100/su26
...
<!-- # <span style="color: red;">NOTICE: The course is now CLOSED to additional students. </span>
{: .no_toc }

**The course is closed and no further enrollment is possible**.  Please do not request an exception - many students are asking for exceptional treatment and the course is already over capacity, unfortunately, we cannot accommodate further requests.
...
# Frequently Asked Questions for Summer 2026 Data 100
{: .no_toc }
...
## Who should I contact if I have questions that are not answered below? 

Please DO NOT directly email the course instructors using their personal email addresses. 
<!-- There are too few instructors to efficiently address questions from approximately 1,000 enrolled students. -->

Instead, please e-mail [{{page.course.email}}](mailto:{{page.course.email}}) and we will get back to you promptly. To ensure more timely responses, this address is monitored by the instructors, head TAs, and multiple lead GSIs. 

You should only directly contact the instructors for matters that require strict privacy.

---

## Where is the course website?

The Summer 2026 course website is not yet live. The Spring 2026 website can be found [here](https://ds100.org/sp26/).
...
The instructors are not able to provide permission codes or any new information about enrollment in Data 100 at this time. Please refer to the [Data Science Summer 2026 Courses page]({{page.course.classes_page}}){:target="_blank"} and  the [Data 001 Ed]({{page.course.data001edstem}}){:target="_blank"}, which includes all information currently available about enrolling in Summer 2026 classes. If you are not able to find an answer to your question there, please email [ds-advising@berkeley.edu](mailto:ds-advising@berkeley.edu).
...
You can also use the generic [DataHub](https://datahub.berkeley.edu){:target="_blank"} to access copies of the assignments, but you need to remove `data100.` from the beginning of the URL.
...
For students enrolled in the in-person version of Data 100 this summer, we will offer:
...
- There will be no direct lab sessions: A video walk-through of the lab content will be alongside the lab you to watch on your own. There will be online help available for labs through office hours and dedicated Ed channels.

For students enrolled in the online version of Data 100 this summer, we will allow remotely proctored exams so long as sufficient documentation is provided that shows you cannot be on campus at the time of the exams. More information will be released at the beginning of the semester.
...
For students enrolled in the online version of Data 100 this summer, we will allow remotely proctored exams so long as sufficient documentation is provided that shows you cannot be on campus at the time of the exams. More information for online students will be released at the beginning of the semester.
...
The two-part final is scheduled during regular lecture time on the last two days of the course, Wednesday 8/12 and Thursday 8/13.

**Data 100 does not allow lecture time conflicts or final exam conflicts.** 

---
## What is the time conflict policy for the course?
...
<!-- Please see the previous section. The final exam must be taken in person. -->

<!-- There will be no final exams offered outside of the windows detailed in the previous section. -->
...
All midterm details are subject to change before the start of the semester. Everything below is tentative.

There are **three** one-hour midterms. We plan to administer the midterms in the [computer-based testing facilities](https://acelab.berkeley.edu/cbtf/) on campus. 

- You will have the option to sign up for a one hour slot to take the first midterm **Wednesday 7/8 or Thursday 7/9** in the CBTF.

- You will have the option to sign up for a one hour slot to take the second midterm **Wednesday 7/29 or Thursday 7/30** in the CBTF.

- You will have the option to sign up for a one hour slot to take the third midterm **Wednesday 8/5 or Thursday 8/6** in the CBTF.

- We will offer midterm retakes at the CBTF on Wednesday and Thursday the week after each midterm for partial score recovery. The final exam will not have retakes. 
...
Discussion sections and sign-ups will be released within the first two days of class. There will be no lab sessions. See our course policies for more information about labs.
...
<!-- [Here!]({{page.course.edstem}}){:target="_blank"} -->
...
Please e-mail [{{page.course.email}}](mailto:{{page.course.email}}) and we will get back to you. Note that to ensure more timely responses, this address is monitored by instructors, head TAs, and multiple lead GSIs. You should only contact the instructors directly for matters that require strict privacy and their direct attention.

---
We’re excited to have you in the class!

Josh (Professor), Sarah (Professor), Rohan (Head TA), and the Summer 2026 instructional team.