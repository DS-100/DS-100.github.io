...
As of Aug. 22, 2023, **the course is closed and no further enrollment is possible**.  Please do not request an exception - many students are asking for exceptional treatment and the course is already over capacity, unfortunately, we can not accommodate further requests.
