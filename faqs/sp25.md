...
Once you've exhausted your slip days, we will only provide an extension in case of a _major and documented_ set of exceptional circumstances (death in the family, illness documented with medical paperwork, or similar). In such case, you can contact our Student Support TA, {{page.course.comms_ta}}, providing documentation that supports your case. Given the already flexible slip days policy, these exceptions will only be granted sparingly.
