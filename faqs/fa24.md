...
As of Aug. 28, 2024, **the course is closed and no further enrollment is possible**.  Please do not request an exception - many students are asking for exceptional treatment and the course is already over capacity, unfortunately, we can not accommodate further requests.
...
If you are a Concurrent Enrollment student, you can find more information [here](https://docs.google.com/document/d/1aXIq08VxrSotKqwgqByb_nQaOi1p76iaeW8mTeZGyKI).
...
The course is closed as of August 28, 2024; there will be no further enrollment.
...
## I have a Concurrent Enrollment Request that hasn't been approved yet, what should I do? What are my chances of getting into this class?
 ...
 Since the course is at full capacity as of August 28th, there will be no further enrollment. However, you can **see above for how to get added to any other required resources**.
...
The course website for Fall 2024 is linked [here]({{page.course.website}}).
