...
* Notebook Review of Least-Squares Linear Regression: ([html](assets/notebooks/linear_regression/Least_Squares_Regression.html.html), [ipynb](assets/notebooks/linear_regression/Least_Squares_Regression.html.ipynb)) this has some fun visualizations (in 3D!) as well as alternative derivations and notational clarifications.
